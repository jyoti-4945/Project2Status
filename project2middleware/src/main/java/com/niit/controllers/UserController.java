...
public  ResponseEntity<?>  registration(@RequestBody User user){
	...
	try{
		System.out.println("hello m here in reg");
	userDao.registerUser(user);
	return new ResponseEntity<Void>(HttpStatus.OK);
	}catch(Exception e){//Constraint violation
		System.out.println("hello m here in exceptn");
...
//	System.out.println("Session Id Is " +session.getId());
//	System.out.println("Session Creation Time is " + session.getCreationTime());
//	System.out.println("Session Attribute Email is "+session.getAttribute("email"));
